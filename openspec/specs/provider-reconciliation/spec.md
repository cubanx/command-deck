...
The system MUST preserve the last known evidence and expose stale/error state when reconciliation fails, including failure on any page of a paginated resource, rather than marking the resource verified or current.
