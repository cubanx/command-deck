...
- [ ] 4.3 Run the applicable focused tests, typecheck, strict OpenSpec validation, and `git diff --check`.
...
- [ ] 7.4 Advance the cached shell application asset and run focused tests, typecheck, strict OpenSpec validation, and `git diff --check`.
...
- [ ] 8.3 Run the applicable focused tests, typecheck, strict OpenSpec validation, and `git diff --check`.
...
- [ ] 9.3 Run the focused dashboard tests, typecheck, strict OpenSpec validation, and `git diff --check`.
...
- [ ] 10.3 Run focused dashboard and static-shell tests, typecheck, strict OpenSpec validation, and `git diff --check`.
...
- [ ] 11.3 Run focused dashboard and static-shell tests, typecheck, strict OpenSpec validation, and `git diff --check`.
...
- [ ] 12.3 Run focused dashboard and static-shell tests, typecheck, strict OpenSpec validation, and `git diff --check`.
...
- [ ] 14.3 Rebuild the browser asset and run focused tests, typecheck, strict OpenSpec validation, and `git diff --check`.
...
- [ ] 16.3 Run focused tests, typecheck, strict OpenSpec validation, and `git diff --check`.
...
- [ ] 17.3 Run focused tests, typecheck, strict OpenSpec validation, and `git diff --check`.
...
- [ ] 18.3 Run focused tests, typecheck, strict OpenSpec validation, and `git diff --check`.
