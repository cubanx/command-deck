...
**Reason:** Railway hints and verification are not runtime inputs after the GitHub-native deployment boundary.

**Migration:** Replace Railway-derived transitions with signed GitHub `deployment_status` transitions scoped to the verified installation.
