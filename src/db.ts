...
export function openDatabase(path = ":memory:"): Db {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS pull_requests (installation_id TEXT NOT NULL, repository_id TEXT NOT NULL, number INTEGER NOT NULL, title TEXT NOT NULL, url TEXT, author_login TEXT, state TEXT NOT NULL, mergeable TEXT, review_state TEXT, checks_state TEXT, workflow_state TEXT, updated_at TEXT, PRIMARY KEY (installation_id, repository_id, number));
